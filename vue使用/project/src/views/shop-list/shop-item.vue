		...
		<div>
			...
			<div class="params-colors">
				<ul class="colors-list">
					<li v-for="icon,i in icons" @mouseenter="index=i"><a href="javascript:;" :class="{active:i===index}"><img :src="icon"></a></li>
				</ul>
			</div>
			<div class="item-btns clearfix">
				...
				<span v-show="items.direct_to_cart" class="item-blue-btn" @click="addShopCar">加入购物车 </span>
			</div>
